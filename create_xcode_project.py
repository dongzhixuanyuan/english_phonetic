...
# Write ReaderView.swift
readerview = '''import SwiftUI
...
with open(os.path.join(project_dir, "EnglishPhoneticApp/Views/ReaderView.swift"), "w") as f:
    f.write(readerview)

# Write CameraPicker.swift
camerapicker = '''import SwiftUI
...
with open(os.path.join(project_dir, "EnglishPhoneticApp/Views/CameraPicker.swift"), "w") as f:
    f.write(camerapicker)

print("Created ReaderView.swift and CameraPicker.swift")
